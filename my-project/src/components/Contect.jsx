...
const Contect = () => {
  return (
    ...
    <div className="  bg-[url('https://cdn.pixabay.com/photo/2020/10/13/13/28/ameland-5651866_1280.jpg')] h-screen w-screen  py-30 object-cover flex justify-center items-center bg-no-repeat ">
        ...
        <div className="w-200  ">
          <div id="bg" className="flex justify-center mb-20 font-bold text-3xl bg-[url('https://cdn.pixabay.com/photo/2016/10/22/10/07/background-1760270_1280.jpg')] lg-text-8xl sm:text-5xl">
      BANIYA CONSTRUCTION
    </div>
        <form className="justify-center items-center bg-white w-200px flex-col p-10 " action="">
